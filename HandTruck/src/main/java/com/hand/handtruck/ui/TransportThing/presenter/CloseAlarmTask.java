...
public class CloseAlarmTask {
    private static Handler mHandler;
    private static Context mContext;
    private static CloseAlarmTask instance = null;
    public CloseAlarmTask() {
    }


    public static CloseAlarmTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new CloseAlarmTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
