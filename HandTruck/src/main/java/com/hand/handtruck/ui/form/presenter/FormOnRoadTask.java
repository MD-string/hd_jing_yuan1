...
public class FormOnRoadTask {
    private static Handler mHandler;
    private static Context mContext;
    private static FormOnRoadTask instance = null;
    public FormOnRoadTask() {
    }


    public static FormOnRoadTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new FormOnRoadTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
