 ...
 * 
 */
public class LogisticsExAdapter extends BaseAdapter {

	private  List<FormBean> mList;
	private Context context;
	private LayoutInflater inflater;

	public LogisticsExAdapter(Context context, List<FormBean> list){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView =inflater.inflate(R.layout.act_logs_ex, null);
