 ...
 * 
 */
public class ParkCarAlarmAdapter extends BaseAdapter {

	private  List<TransportBean> mList;
	private Context context;
	private LayoutInflater inflater;

	public ParkCarAlarmAdapter(Context context, List<TransportBean> list){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView =inflater.inflate(R.layout.item_park_car, null);
		...
		if(item != null ){
			...
			String name=item.getFactoryName();
			viewHold.tv_cust_name.setText(name+"");
			String offDate=item.getParkStartTime();
