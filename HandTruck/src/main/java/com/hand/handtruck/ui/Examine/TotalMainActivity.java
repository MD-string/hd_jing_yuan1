 ...
 * 2018-12-3
 * */
public class TotalMainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public static void start(Context context, FormBean bean){
        Intent i=new Intent(context, TotalMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context =this;
        //透明状态栏
        CommonKitUtil.windowTranslucentStatus(TotalMainActivity.this);
    ...
    protected void findViews() {
        mContext = TotalMainActivity.this;
        ...
        tv_tab_2.setText("订单审核");
        img_1=(ImageView)findViewById(R.id.img_1);
        img_2=(ImageView)findViewById(R.id.img_2);
        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_summary));
    ...
    protected void inIt() {
        ...
        TotalContentExFragment totalFrgment=new TotalContentExFragment();
        Bundle bundle1 = new Bundle();
        /*往bundle中添加数据*/
        bundle1.putSerializable("formBean", (Serializable)formBean);
        /*把数据设置到Fragment中*/
        totalFrgment.setArguments(bundle1);

        mFragmentList.add(moreFrg);  //订单详情
        mFragmentList.add(totalFrgment);  //取证处理
...
//                switchBorderTab(position);
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_summary_white));
