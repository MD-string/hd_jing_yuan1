...
public class FormErrorTask {
    private static Handler mHandler;
    private static Context mContext;
    private static FormErrorTask instance = null;
    public FormErrorTask() {
    }


    public static FormErrorTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new FormErrorTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
