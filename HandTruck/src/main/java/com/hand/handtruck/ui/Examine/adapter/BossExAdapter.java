 ...
 * 
 */
public class BossExAdapter extends BaseAdapter {

	private  List<FormBean> mList;
	private Context context;
	private LayoutInflater inflater;

	public BossExAdapter(Context context, List<FormBean> list){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView =inflater.inflate(R.layout.act_boss_ex, null);
		...
		if(item != null ){
			...
			String adsice2=item.getLevel3CheckMsg();
