...
public class ParkCarAlarmTask {
    private static Handler mHandler;
    private static Context mContext;
    private static ParkCarAlarmTask instance = null;
    public ParkCarAlarmTask() {
    }


    public static ParkCarAlarmTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new ParkCarAlarmTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
