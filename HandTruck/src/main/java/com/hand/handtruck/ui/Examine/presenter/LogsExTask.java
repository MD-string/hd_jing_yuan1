...
public class LogsExTask {
    private static Handler mHandler;
    private static Context mContext;
    private static LogsExTask instance = null;
    public LogsExTask() {
    }


    public static LogsExTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new LogsExTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
