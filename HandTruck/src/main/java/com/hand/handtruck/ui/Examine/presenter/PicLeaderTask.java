...
public class PicLeaderTask {
    private static Handler mHandler;
    private static Context mContext;
    private static PicLeaderTask instance = null;
    public PicLeaderTask() {
    }


    public static PicLeaderTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new PicLeaderTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
