 ...
 * 2018-12-3
 * */
public class PicLeadExamineActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public static void start(Context context, FormBean bean){
        Intent i=new Intent(context, PicLeadExamineActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context =this;
        //透明状态栏
        CommonKitUtil.windowTranslucentStatus(PicLeadExamineActivity.this);
    ...
    protected void findViews() {
        mContext = PicLeadExamineActivity.this;
        ...
        tv_tab_2.setText("分管领导审核");
        img_1=(ImageView)findViewById(R.id.img_1);
        img_2=(ImageView)findViewById(R.id.img_2);
        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_leader));
    ...
    protected void inIt() {
        ...
        PicLeaderExamineFragment plFrgment=new PicLeaderExamineFragment();
        Bundle bundle1 = new Bundle();
        /*往bundle中添加数据*/
        bundle1.putSerializable("formBean", (Serializable)formBean);
        /*把数据设置到Fragment中*/
        plFrgment.setArguments(bundle1);

        mFragmentList.add(moreFrg);  //订单详情
        mFragmentList.add(plFrgment);  //取证处理
...
//                switchBorderTab(position);
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_leader_white));
