...
public class FormNorTask {
    private static Handler mHandler;
    private static Context mContext;
    private static FormNorTask instance = null;
    public FormNorTask() {
    }


    public static FormNorTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new FormNorTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
    ...
    public void getTransportList(Map<String, String> map) {
        String url = Constants.HttpUrl.ORDER_LIST1;
