...
import com.hand.handtruck.ui.Examine.FormInfoFrgment;
import com.hand.handtruck.ui.Examine.ReaAndColFrgment;
 ...
 * 2018-12-3
 * */
public class AlramContentActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public  static void start(Context context, FormBean bean){
        Intent i=new Intent(context, AlramContentActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_res_ex);
        context =this;
        //透明状态栏
        CommonKitUtil.windowTranslucentStatus(AlramContentActivity.this);
        formBean= (FormBean)getIntent().getSerializableExtra("tansport_bean");
        findViews();
        initTabLineWidth();
        inIt();
        setListeners();
    ...
    protected void findViews() {
        mContext = AlramContentActivity.this;
        mTvBack = (TextView) findViewById(R.id.tv_back);
        mTvBack.setOnClickListener(this);
        mTvBack.setVisibility(View.VISIBLE);
        mTvTitle = (TextView) findViewById(R.id.tv_title);
        mTvTitle.setText("报警详情");
    ...
    protected void inIt() {
        ...
        ReaAndColFrgment rFrgment=new ReaAndColFrgment();
        Bundle bundle1 = new Bundle();
        /*往bundle中添加数据*/
        bundle1.putSerializable("formBean", (Serializable)formBean);
        /*把数据设置到Fragment中*/
        rFrgment.setArguments(bundle1);

        mFragmentList.add(moreFrg);  //订单详情
        mFragmentList.add(rFrgment);  //取证处理
...
//                switchBorderTab(position);
                ...
                switch (position) {
                    case 0:
                        ...
                        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_evidence));
                    ...
                    case 1:
                        ...
                        img_2.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.order_check_evidence_white));
