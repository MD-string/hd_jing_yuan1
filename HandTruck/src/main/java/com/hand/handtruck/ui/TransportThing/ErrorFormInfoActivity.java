...
public class ErrorFormInfoActivity extends Activity implements View.OnClickListener {
    ...
    public  static void start(Context context, FormBean bean){
        Intent i=new Intent(context, ErrorFormInfoActivity.class);
...
//                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_error_more);
        mContext=this;
    ...
    protected void findViews() {
        ...
        tv_out_address.setText(bean.getSaleAreaName()+"");
