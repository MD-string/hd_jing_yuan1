...
public class FormDevErrorTask {
    private static Handler mHandler;
    private static Context mContext;
    private static FormDevErrorTask instance = null;
    public FormDevErrorTask() {
    }


    public static FormDevErrorTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new FormDevErrorTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
