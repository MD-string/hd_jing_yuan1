...
public class TotalEXTask {
    private static Handler mHandler;
    private static Context mContext;
    private static TotalEXTask instance = null;
    public TotalEXTask() {
    }


    public static TotalEXTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new TotalEXTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
