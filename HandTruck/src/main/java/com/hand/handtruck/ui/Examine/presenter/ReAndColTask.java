...
public class ReAndColTask {
    private static Handler mHandler;
    private static Context mContext;
    private static ReAndColTask instance = null;
    public ReAndColTask() {
    }


    public static ReAndColTask getInstance(Context context, Handler handler) {
        if (instance == null) {
            instance = new ReAndColTask();
        }
        mContext = context;
        mHandler = handler;
        return instance;
