 ...
 * 2018-12-3
 * */
public class ResearchExamineActivity extends FragmentActivity implements View.OnClickListener {
    ...
    public static void startReaAndColAct(Context context, FormBean bean){
        Intent i=new Intent(context, ResearchExamineActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context =this;
        //透明状态栏
        CommonKitUtil.windowTranslucentStatus(ResearchExamineActivity.this);
    ...
    protected void findViews() {
        mContext = ResearchExamineActivity.this;
        mTvBack = (TextView) findViewById(R.id.tv_back);
        mTvBack.setOnClickListener(this);
        mTvBack.setVisibility(View.VISIBLE);
        mTvTitle = (TextView) findViewById(R.id.tv_title);
        mTvTitle.setText("调研取证");
