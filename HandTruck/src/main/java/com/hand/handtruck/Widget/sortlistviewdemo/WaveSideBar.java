...
public class WaveSideBar extends View {
    ...
    private void drawLetters(Canvas canvas) {
        ...
        rectF.top = mHeight/2-mItemHeight*(mLetters.size()+1)/2;
        rectF.bottom =mItemHeight*(mLetters.size()+1)+ rectF.top;
        ...
        for (int i = 0; i < mLetters.size(); i++) {
            ...
            if (i == mChoosePosition) {
                ...
                canvas.drawText(mLetters.get(i), mPointX, pointY+ rectF.top, mLettersPaint);
            }
        }
    ...
    public void updateListView(List<String> letters) {
        this.mLetters = letters;
        invalidate();
    }
